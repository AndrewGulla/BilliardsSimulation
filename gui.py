...
def drawTable():
	...
	cueball = sphere(pos = (0,0.4,-8), radius=0.234375, material=ballTex[0], zCheck=False, xCheck=False, name="cueball")
	collision = [None]*15
	collision[0] = sphere(pos = (0,0.4,5), radius=0.234375, material=ballTex[1], zCheck=False, xCheck=False, name="collision")
	collision[1] = sphere(pos = (0.5,0.4,5), radius=0.234375, material=ballTex[15], zCheck=False, xCheck=False, name="collision2")
	collision[2] = sphere(pos = (1,0.4,5), radius=0.234375, material=ballTex[2], zCheck=False, xCheck=False, name="collision3")
	collision[3] = sphere(pos = (-0.5,0.4,5), radius=0.234375, material=ballTex[14], zCheck=False, xCheck=False, name="collision4")
	collision[4] = sphere(pos = (-1,0.4,5), radius=0.234375, material=ballTex[3], zCheck=False, xCheck=False, name="collision5")
	collision[5] = sphere(pos = (0.25,0.4,4.5), radius=0.234375, material=ballTex[13], zCheck=False, xCheck=False, name="collision6")
	collision[6] = sphere(pos = (-0.25,0.4,4.5), radius=0.234375, material=ballTex[4], zCheck=False, xCheck=False, name="collision7")
	collision[7] = sphere(pos = (0.75,0.4,4.5), radius=0.234375, material=ballTex[12], zCheck=False, xCheck=False, name="collision8")
	collision[8] = sphere(pos = (-0.75,0.4,4.5), radius=0.234375, material=ballTex[5], zCheck=False, xCheck=False, name="collision9")
	collision[9] = sphere(pos = (-0.5,0.4,4), radius=0.234375, material=ballTex[11], zCheck=False, xCheck=False, name="collision10")
	collision[10] = sphere(pos = (0,0.4,4), radius=0.234375, material=ballTex[8], zCheck=False, xCheck=False, name="collision11")
	collision[11] = sphere(pos = (0.5,0.4,4), radius=0.234375, material=ballTex[10], zCheck=False, xCheck=False, name="collision12")
	collision[12] = sphere(pos = (0.25,0.4,3.5), radius=0.234375, material=ballTex[7], zCheck=False, xCheck=False, name="collision13")
	collision[13] = sphere(pos = (-0.25,0.4,3.5), radius=0.234375, material=ballTex[9], zCheck=False, xCheck=False, name="collision14")
	collision[14] = sphere(pos = (-0,0.4,3), radius=0.234375, material=ballTex[6], zCheck=False, xCheck=False, name="collision15")
